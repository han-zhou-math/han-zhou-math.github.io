...
1. *On the global asymptotic stability for the 3D Peskin Problem at critical regularity.* [arXiv](https://doi.org/10.48550/arXiv.2607.11731)<br>
   Eduardo García-Juárez, Susanna V. Haziot, Po-Chun Kuo, Yoichiro Mori, Han Zhou.

2. *Stability and equilibria of a compressible elastic membrane in Stokes flow.* [arXiv](https://doi.org/10.48550/arXiv.2607.03357)<br>
   Sho Kawakami, Han Zhou, Po-Chun Kuo, Yoichiro Mori, Yuan-Nan Young.

3. *Principal-part decomposition for neural operator learning of Dirichlet-to-Neumann maps.* [arXiv](https://doi.org/10.48550/arXiv.2606.25952)<br>
   Shuo Ling, Wenjun Ying, Han Zhou.

4. *Bulk-surface coupled PDE with an open boundary.* [arXiv](https://doi.org/10.48550/arXiv.2604.20798)<br>
   Charles L. Epstein, Yoichiro Mori, Han Zhou.

5. *A correction function-based KFBI method for Brinkman interface problems.* [arXiv](https://doi.org/10.48550/arXiv.2604.15509)<br>
   Han Zhou, Wenjun Ying.

6. *Modeling and simulation of open membranes in Stokes flow with mixed-dimensional coupling.*<br>
   Han Zhou, Yuan-Nan Young, Yoichiro Mori.<br>
...
7. *A kernel-free boundary integral method for elliptic interface problems on surfaces.*<br>
   Pengsong Yin, Wenjun Ying, Yulin Zhang, Han Zhou.<br>
   *Journal of Computational Physics*, 562:115004, 2026. [DOI](https://doi.org/10.1016/j.jcp.2026.115004)

8. *An alternating direction implicit method for mean curvature flows.*<br>
   Han Zhou, Shuwang Li, Wenjun Ying.<br>
   *Journal of Scientific Computing*, 101:65, 2024. [DOI](https://doi.org/10.1007/s10915-024-02701-3)

9. *A correction function-based kernel-free boundary integral method for elliptic PDEs with implicitly defined interfaces.*<br>
   Han Zhou, Wenjun Ying.<br>
   *Journal of Computational Physics*, 496:112545, 2024. [DOI](https://doi.org/10.1016/j.jcp.2023.112545)

10. *A kernel-free boundary integral method for the nonlinear Poisson-Boltzmann equation.*<br>
    Han Zhou, Jiahe Yang, Wenjun Ying.<br>
    *Journal of Computational Physics*, 493:112423, 2023. [DOI](https://doi.org/10.1016/j.jcp.2023.112423)

11. *A Cartesian grid-based boundary integral method for moving interface problems.* [arXiv](https://doi.org/10.48550/arXiv.2309.01068)<br>
    Han Zhou, Shuwang Li, Wenjun Ying.

12. *ADI schemes for the heat equation on arbitrary 3D domains and their applications.* [arXiv](https://doi.org/10.48550/arXiv.2309.00979)<br>
    Han Zhou, Minsheng Huang, Wenjun Ying.

13. *A dimension splitting method for time dependent PDEs on irregular domains.*<br>
    Han Zhou, Wenjun Ying.<br>
    *Journal of Scientific Computing*, 94(1):20, 2023. [DOI](https://doi.org/10.1007/s10915-022-02066-5)

14. *A phase-field method for elastic mechanics with large deformation.*<br>
    Jiacheng Xu, Dan Hu, Han Zhou.<br>
...
- *Numerical Analysis and PDE Seminar*, Newark, May 2025
- *Fluid Mechanics and Waves Seminar*, Newark, November 2024
- *NCTS Seminar on PDE and Machine Learning*, Online, October 2024
- *The 10th International Congress on Industrial and Applied Mathematics*, Tokyo, August 2023
- *SICIAM Workshop on Recent Advances in Fast Algorithms*, Shenzhen, August 2023
- *Chinese Mathematical Society in Computational Mathematics*, Nanjing, July 2023
- *CSIAM Student Forum*, Online, November 2022
- *Shanghai Symposium on Scientific and Engineering Computing Methods*, Shanghai, November 2021
